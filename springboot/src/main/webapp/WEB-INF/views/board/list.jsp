  ...
  <body>
    ...
    <div class="container">
      <div style="display: flex; justify-content: space-between">
        <!--글쓰는 창으로 가는 버튼-->
        <input type="button" class="btn btn-secondary" value="글쓰기" onclick="location.href='${root}/board/write'"/></input>
        <div>
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="#" class="article-title link-dark" data-no="${article.articleNo }" style="text-decoration: none">
            	${article.subject }</a>
            </td>
